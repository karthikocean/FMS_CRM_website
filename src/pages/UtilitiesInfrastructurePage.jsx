...
import {
  utilitiesInfrastructureData,
  seoData
} from "../data/UtilitiesInfrastructureData";
...
const UtilitiesInfrastructurePage = () => {
  const data = utilitiesInfrastructureData;

  return (
    <div className="ind-details-page">
      {/* Declarative SEO Metadata via React Helmet Async */}
      <SEO
        title="Utility Grid & Infrastructure Operations | FacilityCore"
        description="Maintain utility grids, power plants, and public infrastructure using FacilityCore software for preventive maintenance schedules and regulatory compliance."
        keywords="utility infrastructure maintenance, power plant asset care, grid facility software"
      />
      ...
      <section className="ind-stats-section" aria-label="Key Utility Statistics">
      ...
      <section className="ind-overview-section" aria-label="Utility Operations Overview">
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Target Utility Facilities">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiGrid /> VERSATILE DEPLOYMENT
            </span>
            <h2 className="ind-overview-title">Suitable For Diverse Utility & Infrastructure Facilities</h2>
            <p className="ind-overview-subtitle">
              Engineered for utility directors, chief engineers, power plant leads, and solar farm operators.
            </p>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Utility Challenges Solved">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              {data.challengesBadgeIcon} {data.challengesBadge}
            </span>
            <h2 className="ind-overview-title">Utility Challenges & How FacilityCore Solves Them</h2>
          </div>
      ...
      <section className="ind-solutions-section" aria-label="Key Utility Modules">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              {data.capabilitiesBadgeIcon} {data.capabilitiesBadge}
            </span>
            <h2 className="ind-overview-title">12 Purpose-Built Modules for Utility & Infrastructure Operations</h2>
            <p className="ind-overview-subtitle">
              Comprehensive operational tools tailored for electrical substations, water treatment, solar PV farms, and EHS safety.
            </p>
          </div>
      ...
      <section className="ind-features-section" style={{ background: "#FFFFFF" }} aria-label="FacilityCore Utility Modules">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiGrid /> FULL UTILITIES SUITE
            </span>
            <h2 className="ind-overview-title">All Utility & Infrastructure Modules Included</h2>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Typical Infrastructure Assets Managed">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiShield /> INFRASTRUCTURE ASSET COVERAGE
            </span>
            <h2 className="ind-overview-title">Typical Utility Assets & Infrastructure Managed</h2>
            <p className="ind-overview-subtitle">
              Maximize availability for electrical substations, STP/ETP pumps, solar inverters, gas skids, and DG sets.
            </p>
          </div>
            ...
            <table className="ind-custom-table">
              <thead>
                <tr>
                  ...
                  <th>Managed Utility Infrastructure & Heavy Equipment</th>
                </tr>
              </thead>
              <tbody>
      ...
      {/* DAILY UTILITY WORKFLOW */}
      <section className="ind-solutions-section" style={{ background: "#FFFFFF" }} aria-label="Daily Utility Plant SLA Workflow">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiBarChart2 /> WORKFLOW SLA
            </span>
            <h2 className="ind-overview-title">Daily Substation & STP Maintenance SLA Workflow</h2>
            <p className="ind-overview-subtitle">
      ...
      <section className="ind-features-section" aria-label="Strategic Benefits & Dashboard">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <h2 className="ind-overview-title">Key Business Benefits for Utility Facilities</h2>
          </div>
          ...
          <div className="ind-solutions-header" style={{ marginTop: 64 }}>
            ...
            <h2 className="ind-overview-title">Real-Time Control Room Dashboard Widgets</h2>
          </div>
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Why Choose FacilityCore">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            ...
            <h2 className="ind-overview-title">FacilityCore vs Traditional Utility Management</h2>
          </div>
            ...
            <table className="ind-custom-table ind-comparison-table">
              <thead>
                <tr>
                  ...
                  <th className="fac-header">FacilityCore Utility Platform</th>
      ...
      <section className="ind-features-section" aria-label="Frequently Asked Questions">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <p className="ind-overview-subtitle">
              Everything you need to know about FacilityCore Utilities & Infrastructure Facility Management Software.
            </p>
          </div>
...
export default UtilitiesInfrastructurePage;
