...
const HealthcarePage = () => {
  ...
  return (
    <div className="ind-details-page">
      ...
      <SEO
        title="Hospital & Healthcare Facility Care | FacilityCore"
        description="Maintain regulatory compliance and asset reliability in hospitals and healthcare facilities using FacilityCore's automated maintenance management software."
        keywords="hospital facility software, healthcare asset compliance, medical equipment maintenance"
      />
      ...
      <section className="ind-stats-section" aria-label="Key Healthcare Statistics">
      ...
      <section className="ind-overview-section" aria-label="Healthcare Operations Overview">
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Target Healthcare Facilities">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiGrid /> VERSATILE DEPLOYMENT
            </span>
            <h2 className="ind-overview-title">Suitable For Diverse Healthcare & Medical Facilities</h2>
            <p className="ind-overview-subtitle">
              Engineered for hospital administrators, bio-medical engineers, multi-specialty hospitals, and diagnostic labs.
            </p>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Operational Challenges Solved">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            ...
            <h2 className="ind-overview-title">Healthcare Challenges & How FacilityCore Solves Them</h2>
          </div>
      ...
      <section className="ind-solutions-section" aria-label="Key Healthcare Modules">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              {data.capabilitiesBadgeIcon} {data.capabilitiesBadge}
            </span>
            <h2 className="ind-overview-title">12 Purpose-Built Modules for Hospital Operations</h2>
            <p className="ind-overview-subtitle">
              Comprehensive medical-grade tools tailored for bio-medical engineers, clinical staff, infection control, and EHS leads.
            </p>
          </div>
      ...
      <section className="ind-features-section" style={{ background: "#FFFFFF" }} aria-label="FacilityCore Healthcare Modules">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiGrid /> FULL HEALTHCARE SUITE
            </span>
            <h2 className="ind-overview-title">All Hospital Modules Included</h2>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Typical Healthcare Assets Managed">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiShield /> MEDICAL & FACILITY ASSET COVERAGE
            </span>
            <h2 className="ind-overview-title">Typical Hospital Assets & Equipment Managed</h2>
            <p className="ind-overview-subtitle">
              Maximize availability for biomedical devices, radiology scanners, medical gas systems, OT cleanroom HVAC, and backup power.
            </p>
          </div>
            ...
            <table className="ind-custom-table">
              <thead>
                <tr>
                  ...
                  <th>Managed Healthcare Infrastructure & Medical Devices</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="ind-solutions-section" style={{ background: "#FFFFFF" }} aria-label="Daily Equipment Breakdown SLA Workflow">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiBarChart2 /> EMERGENCY SLA WORKFLOW
            </span>
            <h2 className="ind-overview-title">Daily OT / ICU Equipment Breakdown Workflow</h2>
            <p className="ind-overview-subtitle">
              SLA-driven 9-step resolution process from clinical alarm trigger to RCA log for NABH compliance.
            </p>
          </div>
      ...
      <section className="ind-features-section" aria-label="Strategic Benefits & Dashboard">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <h2 className="ind-overview-title">Key Business Benefits for Healthcare Facilities</h2>
          </div>
          ...
          <div className="ind-solutions-header" style={{ marginTop: 64 }}>
            ...
            <h2 className="ind-overview-title">Real-Time Hospital Executive Dashboard Widgets</h2>
          </div>
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Why Choose FacilityCore">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            ...
            <h2 className="ind-overview-title">FacilityCore vs Traditional Hospital Maintenance</h2>
          </div>
            ...
            <table className="ind-custom-table ind-comparison-table">
              <thead>
                <tr>
                  ...
                  <th className="fac-header">FacilityCore Healthcare Platform</th>
      ...
      <section className="ind-features-section" aria-label="Frequently Asked Questions">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <p className="ind-overview-subtitle">
              Everything you need to know about FacilityCore Healthcare & Hospital Facility Management Software.
            </p>
          </div>
