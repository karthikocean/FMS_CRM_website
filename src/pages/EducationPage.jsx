...
const EducationPage = () => {
  ...
  return (
    <div className="ind-details-page">
      ...
      <SEO
        title="School & University Campus Software | FacilityCore"
        description="Streamline campus operations for schools and universities with FacilityCore software for maintenance work orders, safety compliance, and asset tracking."
        keywords="university campus maintenance, school facility management, educational asset tracking"
      />
      ...
      <section className="ind-stats-section" aria-label="Key Campus Statistics">
      ...
      <section className="ind-overview-section" aria-label="Campus Operations Overview">
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Target Educational Institutions">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiGrid /> VERSATILE DEPLOYMENT
            </span>
            <h2 className="ind-overview-title">Suitable For Diverse Educational Institutions</h2>
            <p className="ind-overview-subtitle">
              Engineered for school principals, university deans, hostel wardens, and campus estate heads.
            </p>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Campus Challenges Solved">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              {data.challengesBadgeIcon} {data.challengesBadge}
            </span>
            <h2 className="ind-overview-title">Campus Challenges & How FacilityCore Solves Them</h2>
          </div>
      ...
      <section className="ind-solutions-section" aria-label="Key Campus Modules">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              {data.capabilitiesBadgeIcon} {data.capabilitiesBadge}
            </span>
            <h2 className="ind-overview-title">12 Purpose-Built Modules for Campus Operations</h2>
            <p className="ind-overview-subtitle">
              Comprehensive operational tools tailored for faculty, hostel wardens, lab coordinators, and estate leads.
            </p>
          </div>
      ...
      <section className="ind-features-section" style={{ background: "#FFFFFF" }} aria-label="FacilityCore Campus Modules">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiGrid /> FULL CAMPUS SUITE
            </span>
            <h2 className="ind-overview-title">All Education Modules Included</h2>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Typical Campus Assets Managed">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiShield /> CAMPUS ASSET COVERAGE
            </span>
            <h2 className="ind-overview-title">Typical Campus Infrastructure & Equipment Managed</h2>
            <p className="ind-overview-subtitle">
              Maximize availability for classrooms, hostels, science labs, bus fleets, sports grounds, and power backups.
            </p>
          </div>
            ...
            <table className="ind-custom-table">
              <thead>
                <tr>
                  ...
                  <th>Managed Campus Infrastructure & Facilities</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="ind-solutions-section" style={{ background: "#FFFFFF" }} aria-label="Daily Campus Maintenance SLA Workflow">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiBarChart2 /> WORKFLOW SLA
            </span>
            <h2 className="ind-overview-title">Daily Classroom & Campus Maintenance Workflow</h2>
            <p className="ind-overview-subtitle">
              SLA-driven 9-step resolution process from issue report to executive BI update.
            </p>
          </div>
      ...
      <section className="ind-features-section" aria-label="Strategic Benefits & Dashboard">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <h2 className="ind-overview-title">Key Business Benefits for Educational Campuses</h2>
          </div>
          ...
          <div className="ind-solutions-header" style={{ marginTop: 64 }}>
            ...
            <h2 className="ind-overview-title">Real-Time Campus Dashboard Widgets</h2>
          </div>
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Why Choose FacilityCore">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            ...
            <h2 className="ind-overview-title">FacilityCore vs Traditional Campus Management</h2>
          </div>
            ...
            <table className="ind-custom-table ind-comparison-table">
              <thead>
                <tr>
                  ...
                  <th className="fac-header">FacilityCore Education Platform</th>
      ...
      <section className="ind-features-section" aria-label="Frequently Asked Questions">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <p className="ind-overview-subtitle">
              Everything you need to know about FacilityCore Education & Campus Facility Management Software.
            </p>
          </div>
