...
import {
  governmentPublicSectorData,
  seoData
} from "../data/GovernmentPublicSectorData";
...
const GovernmentPublicSectorPage = () => {
  const data = governmentPublicSectorData;

  return (
    <div className="ind-details-page">
      {/* Declarative SEO Metadata via React Helmet Async */}
      <SEO
        title="Government & Public Building Operations | FacilityCore"
        description="Manage public sector infrastructure and municipal buildings with secure, compliant FacilityCore software for maintenance tracking and audit readiness."
        keywords="public sector cafm, government building maintenance, municipal facility software"
      />
      ...
      <section className="ind-stats-section" aria-label="Key Government Statistics">
      ...
      <section className="ind-overview-section" aria-label="Government Operations Overview">
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Target Government Facilities">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiGrid /> VERSATILE DEPLOYMENT
            </span>
            <h2 className="ind-overview-title">Suitable For Diverse Government & Public Facilities</h2>
            <p className="ind-overview-subtitle">
              Engineered for public works directors, municipal commissioners, government estate heads, and civic asset leads.
            </p>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Public Sector Challenges Solved">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              {data.challengesBadgeIcon} {data.challengesBadge}
            </span>
            <h2 className="ind-overview-title">Government Challenges & How FacilityCore Solves Them</h2>
          </div>
      ...
      <section className="ind-solutions-section" aria-label="Key Government Modules">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              {data.capabilitiesBadgeIcon} {data.capabilitiesBadge}
            </span>
            <h2 className="ind-overview-title">12 Purpose-Built Modules for Public Sector Operations</h2>
            <p className="ind-overview-subtitle">
              Comprehensive operational tools tailored for secretariats, municipal corporations, public works, and civic facilities.
            </p>
          </div>
      ...
      <section className="ind-features-section" style={{ background: "#FFFFFF" }} aria-label="FacilityCore Government Modules">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiGrid /> FULL PUBLIC SECTOR SUITE
            </span>
            <h2 className="ind-overview-title">All Government Modules Included</h2>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Typical Public Infrastructure Assets Managed">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiShield /> CIVIC ASSET COVERAGE
            </span>
            <h2 className="ind-overview-title">Typical Government Assets & Infrastructure Managed</h2>
            <p className="ind-overview-subtitle">
              Maximize availability for secretariats, courthouses, public utilities, security gates, elevators, and generators.
            </p>
          </div>
            ...
            <table className="ind-custom-table">
              <thead>
                <tr>
                  ...
                  <th>Managed Government Infrastructure & Civic Systems</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="ind-solutions-section" style={{ background: "#FFFFFF" }} aria-label="Daily Maintenance SLA Workflow">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            ...
            <h2 className="ind-overview-title">Daily Government Facility Maintenance SLA Workflow</h2>
            <p className="ind-overview-subtitle">
              SLA-driven 9-step resolution process from issue report to public BI dashboard update.
            </p>
          </div>
      ...
      <section className="ind-features-section" aria-label="Strategic Benefits & Dashboard">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <h2 className="ind-overview-title">Key Business Benefits for Public Sector Facilities</h2>
          </div>
          ...
          <div className="ind-solutions-header" style={{ marginTop: 64 }}>
            ...
            <h2 className="ind-overview-title">Real-Time Government Dashboard Widgets</h2>
          </div>
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Why Choose FacilityCore">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            ...
            <h2 className="ind-overview-title">FacilityCore vs Traditional Public Sector Management</h2>
          </div>
            ...
            <table className="ind-custom-table ind-comparison-table">
              <thead>
                <tr>
                  ...
                  <th className="fac-header">FacilityCore Government Platform</th>
      ...
      <section className="ind-features-section" aria-label="Frequently Asked Questions">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <p className="ind-overview-subtitle">
              Everything you need to know about FacilityCore Government & Public Sector Facility Management Software.
            </p>
          </div>
