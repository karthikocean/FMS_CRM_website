...
import {
  residentialCommunitiesData,
  seoData
} from "../data/ResidentialCommunitiesData";
...
const ResidentialCommunitiesPage = () => {
  const data = residentialCommunitiesData;
  ...
  return (
    <div className="ind-details-page">
      ...
      <section className="ind-overview-section" aria-label="Community Operations Overview">
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Suitable Residential Operations">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiGrid /> VERSATILE DEPLOYMENT
            </span>
            <h2 className="ind-overview-title">Suitable For Diverse Residential Communities</h2>
            <p className="ind-overview-subtitle">
              Engineered for apartment complexes, villa townships, gated layouts, and property management companies.
            </p>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Business Challenges Solved">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              {data.challengesBadgeIcon} {data.challengesBadge}
            </span>
            <h2 className="ind-overview-title">Business Challenges & How FacilityCore Solves Them</h2>
          </div>
      ...
      <section className="ind-solutions-section" aria-label="Key Modules">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              {data.capabilitiesBadgeIcon} {data.capabilitiesBadge}
            </span>
            <h2 className="ind-overview-title">12 Purpose-Built Modules for Residential ERP</h2>
            <p className="ind-overview-subtitle">
              Comprehensive operational tools tailored for residents, associations, security guards, and FM teams.
            </p>
          </div>
      ...
      <section className="ind-features-section" style={{ background: "#FFFFFF" }} aria-label="FacilityCore Modules Used">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiGrid /> FULL MODULE ECOSYSTEM
            </span>
            <h2 className="ind-overview-title">All FacilityCore Modules Included</h2>
          </div>
      ...
      <section className="ind-challenges-section" aria-label="Typical Assets Managed">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            <span className="ind-section-badge">
              <FiShield /> ASSET COVERAGE
            </span>
            <h2 className="ind-overview-title">Typical Community Assets Managed</h2>
            <p className="ind-overview-subtitle">
              Prevent unplanned breakdowns for critical residential infrastructure with QR tracking & PM schedules.
            </p>
          </div>
            ...
            <table className="ind-custom-table">
              <thead>
                <tr>
                  ...
                  <th>Managed Community Infrastructure & Equipment</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="ind-solutions-section" style={{ background: "#FFFFFF" }} aria-label="Daily Community Workflow">
        <div className="ind-solutions-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiBarChart2 /> AUTOMATED SLAS
            </span>
            <h2 className="ind-overview-title">Daily Resident Complaint & Service Workflow</h2>
            <p className="ind-overview-subtitle">
              Transparent 9-step resolution lifecycle from ticket creation to resident rating.
            </p>
          </div>
      ...
      <section className="ind-features-section" aria-label="Business Benefits & Dashboard">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            <span className="ind-section-badge">
              <FiCheckCircle /> STRATEGIC ADVANTAGES
            </span>
            <h2 className="ind-overview-title">Key Business Benefits for Associations</h2>
          </div>
          ...
          <div className="ind-solutions-header" style={{ marginTop: 64 }}>
            ...
            <h2 className="ind-overview-title">Real-Time Executive Dashboard Widgets</h2>
          </div>
      ...
      <section className="ind-challenges-section" style={{ background: "#FFFFFF" }} aria-label="Why Choose FacilityCore">
        <div className="ind-challenges-container">
          <div className="ind-challenges-header">
            ...
            <h2 className="ind-overview-title">FacilityCore vs Traditional Community Management</h2>
          </div>
          ...
          <div className="ind-table-wrapper">
            <table className="ind-custom-table ind-comparison-table">
              <thead>
                <tr>
                  <th style={{ width: "30%" }}>Capability / Module</th>
      ...
      <section className="ind-features-section" aria-label="Frequently Asked Questions">
        <div className="ind-features-container">
          <div className="ind-solutions-header">
            ...
            <p className="ind-overview-subtitle">
              Everything you need to know about FacilityCore Residential Community Management Software.
            </p>
          </div>
...
export default ResidentialCommunitiesPage;
